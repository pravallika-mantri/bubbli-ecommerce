...
urlpatterns = [
    ...
    path('cancelorder/<int:pk>/', views.cancel_order, name='cancelorder'),
    ...
    path('password-reset/',auth_views.PasswordResetView.as_view(template_name='app/password_reset.html', form_class=MyPasswordResetForm, html_email_template_name='app/password_reset_email.html', subject_template_name='app/password_reset_subject.txt',), name='password_reset'),
...
admin.site.site_header = "Bubbli Boba" 
admin.site.site_title = "Bubbli Boba"   
admin.site.site_index_title = "Welcome to Bubbli Boba Shop"